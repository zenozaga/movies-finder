...
var CuevanaChat = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        repsonse = _b.sent();
                        return [2 /*return*/, this.parseCollectionHTML((_a = repsonse.body) !== null && _a !== void 0 ? _a : repsonse, undefined, type)];
                }
            });
        });
    };
    ...
    CuevanaChat.prototype.sections = function () {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var home, returner;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        if (((_a = home.topMovies) === null || _a === void 0 ? void 0 : _a.length) || ((_b = home.topSeries) === null || _b === void 0 ? void 0 : _b.length))
                            returner.push({
                                title: "Top de Hoy",
                                items: __spreadArray(__spreadArray([], ((_c = home.topMovies) !== null && _c !== void 0 ? _c : []), true), ((_d = home.topSeries) !== null && _d !== void 0 ? _d : []), true),
                                type: "poster",
                            });
