...
var Cuevana = /** @class */ (function (_super) {
    __extends(Cuevana, _super);
    function Cuevana() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "Cuevana";
        _this.site = "https://w4.cuevana3.ai/";
        _this.language = "es";
        return _this;
    }
    Cuevana.prototype.match = function (urlOrID) {
     ...
     * @returns {{}}
     */
    Cuevana.prototype.headers = function (extra) {
        var _a;
     ...
     * @returns
     */
    Cuevana.prototype.checkMovePermanent = function (promise) {
        var _a, _b, _c;
    ...
    Cuevana.prototype.parseMovieHTML = function (html, type) {
        var _this = this;
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v;
        if (type === void 0) { type = ""; }
        var $this = this;
        ...
        if ($("#OptY iframe")) {
            trailers.push("".concat((_t = $("#OptY iframe")) === null || _t === void 0 ? void 0 : _t.attr("data-src")));
        }
        $("[data-tplayernv]").each(function (index, ele) {
            var _a, _b;
            var element = $(ele);
            var id = element.attr("data-tplayernv");
            var iframe = $("#".concat(id, " iframe"));
     ...
     * @param {String} url
     */
    Cuevana.prototype.fixUrl = function (url) {
        if (url.startsWith("//")) {
            url = "https:" + url;
        }
        return url;
    };
    Cuevana.prototype.byType = function (type, options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    Cuevana.prototype.search = function (query, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Cuevana.prototype.getById = function (idorLink, type) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Cuevana.prototype.top = function () {
        throw new Error("Method not implemented.");
    };
    Cuevana.prototype.topMovies = function () {
        throw new Error("Method not implemented.");
    };
    Cuevana.prototype.topSeries = function () {
        throw new Error("Method not implemented.");
    };
    Cuevana.prototype.home = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, body, episodes, series, movies;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        movies = this.parseCollectionHTML(body);
                        return [2 /*return*/, {
                                series: series,
                                movies: movies,
                                episodes: episodes,
    ...
    Cuevana.prototype.movies = function (options) {
        return this.byType("movie", options);
    };
    Cuevana.prototype.movie = function (id, options) {
        return this.getById(id, "movie");
    };
    Cuevana.prototype.series = function (options) {
        return this.byType("tv", options);
    };
    Cuevana.prototype.serie = function (id, options) {
        return this.getById(id, "tv");
    };
    Cuevana.prototype.seasons = function (serieID, options) {
        return __awaiter(this, void 0, void 0, function () {
            var serie;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Cuevana.prototype.season = function (id, serieID, options) {
    ...
    Cuevana.prototype.episodes = function (seasonID, serieID, options) {
        return __awaiter(this, void 0, void 0, function () {
            var serie;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Cuevana.prototype.episode = function (id, seasonID, serieID, options) {
        return __awaiter(this, void 0, void 0, function () {
            var episode;
            return __generator(this, function (_a) {
    ...
    Cuevana.prototype.genders = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Cuevana.prototype.cast = function (options) {
        throw new Error("Method not implemented.");
    };
    Cuevana.prototype.sections = function () {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var home, returner;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        if (((_a = home.topMovies) === null || _a === void 0 ? void 0 : _a.length) || ((_b = home.topSeries) === null || _b === void 0 ? void 0 : _b.length))
                            returner.push({
                                title: "Top de Hoy",
                                items: __spreadArray(__spreadArray([], ((_c = home.topMovies) !== null && _c !== void 0 ? _c : []), true), ((_d = home.topSeries) !== null && _d !== void 0 ? _d : []), true).sort(),
                                type: "poster",
                            });
