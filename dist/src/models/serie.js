...
var Serie = /** @class */ (function () {
    function Serie(id, link, title, subtitle, description, rating, votes, released, year, poster, background, trailers, imdbID, tmdbID, fetcher, seasons, cast, genders, relates, networks) {
        if (relates === void 0) { relates = []; }
        if (networks === void 0) { networks = []; }
        this.id = id;
        this.link = link;
        this.title = title;
